...
- [Playlist de videoaulas de Códigos básicos RISC-V utilizando RARS](https://youtube.com/playlist?list=PLzTLX3qxmgSDt4PaQI3Zk95b31lFp4ujh&si=V6rpoQRA5EzzVz1_) ensinando como abrir o RARS pelo terminal e programas básicos como: Return 0, imprimir um inteiro, ler um inteiro, ler mais de um inteiro, operações aritméticas, imprimir texto, condicionais (if-else) e laços de repetição (while). Os códigos desenvolvidos durante as aulas estão disponíveis no repositório [Codigos-basicos-RISC-V-utilizando-RARS](https://github.com/GabrieldeMedeiros05/Codigos-basicos-RISC-V-utilizando-RARS).
